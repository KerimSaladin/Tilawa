                ...
                <div class="recitation-list">
                    ...
                    <div class="recitation-card">
                        ...
                        <video data-custom-player preload="metadata" style="width: 100%; max-width: 600px; margin-bottom: 1rem;">
                            <source src="<?php echo file_url($rec['video_file_path']); ?>" type="<?php echo $video_mime; ?>">
                            المتصفح الخاص بك لا يدعم تشغيل الفيديو.
                        </video>
                        <?php elseif ($rec['audio_file_path']): ?>
                        <audio controls preload="metadata" style="width: 100%; margin-bottom: 1rem;">
                            <source src="<?php echo file_url($rec['audio_file_path']); ?>" type="audio/mpeg">
                            <source src="<?php echo file_url($rec['audio_file_path']); ?>" type="audio/webm">
                            <source src="<?php echo file_url($rec['audio_file_path']); ?>" type="audio/ogg">
                            <source src="<?php echo file_url($rec['audio_file_path']); ?>" type="audio/wav">
                        ...
                        <div style="background-color: var(--cream-bg); padding: 1rem; border-radius: 10px; margin-top: 1rem;">
                            ...
                            <div style="margin-top: 0.75rem; padding-top: 0.75rem; border-top: 1px dashed #ddd;">
                                ...
                                <audio controls style="width: 100%; margin-top: 0.5rem; max-width: 400px;">
                                    <source src="<?php echo file_url($rec['voice_feedback_path'], 'serve_audio.php'); ?>" type="audio/webm">
                                    المتصفح الخاص بك لا يدعم تشغيل الصوت.
                                </audio>
                            </div>
                            <?php endif; ?>
            ...
            <div class="upload-section">
                ...
                <div class="recitation-card" style="margin-bottom: 2rem;">
                    ...
                    <video data-custom-player preload="metadata" style="width: 100%; max-width: 600px; margin: 1rem 0;">
                        <source src="<?php echo file_url($recitation['video_file_path']); ?>" type="<?php echo $video_mime; ?>">
                        المتصفح الخاص بك لا يدعم تشغيل الفيديو.
                    </video>
                    <?php elseif ($recitation['audio_file_path']): ?>
                    <audio controls preload="metadata" style="width: 100%; margin: 1rem 0;">
                        <source src="<?php echo file_url($recitation['audio_file_path']); ?>" type="audio/mpeg">
                        <source src="<?php echo file_url($recitation['audio_file_path']); ?>" type="audio/webm">
                        <source src="<?php echo file_url($recitation['audio_file_path']); ?>" type="audio/ogg">
                        <source src="<?php echo file_url($recitation['audio_file_path']); ?>" type="audio/wav">
                        المتصفح الخاص بك لا يدعم تشغيل الصوت.
                    </audio>
                    <?php endif; ?>
                </div>
                ...
                <div class="recitation-card">
                    ...
                    <div style="margin-top: 1rem; padding: 1rem; background: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%); border-radius: 10px; border: 1px solid #64b5f6;">
                        ...
                        <audio controls style="width: 100%; max-width: 400px;">
                            <source src="<?php echo file_url($correction['voice_feedback_path'], 'serve_audio.php'); ?>" type="audio/webm">
                            المتصفح الخاص بك لا يدعم تشغيل الصوت.
                        </audio>
                    </div>
                    <?php endif; ?>
